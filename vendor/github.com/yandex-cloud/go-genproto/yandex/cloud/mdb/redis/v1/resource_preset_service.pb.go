...
func (x *GetResourcePresetRequest) Reset() {
	*x = GetResourcePresetRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_yandex_cloud_mdb_redis_v1_resource_preset_service_proto_msgTypes[0]
...
func (*GetResourcePresetRequest) Descriptor() ([]byte, []int) {
	return file_yandex_cloud_mdb_redis_v1_resource_preset_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *ListResourcePresetsRequest) Reset() {
	*x = ListResourcePresetsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_yandex_cloud_mdb_redis_v1_resource_preset_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ListResourcePresetsRequest) Descriptor() ([]byte, []int) {
	return file_yandex_cloud_mdb_redis_v1_resource_preset_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *ListResourcePresetsResponse) Reset() {
	*x = ListResourcePresetsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_yandex_cloud_mdb_redis_v1_resource_preset_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ListResourcePresetsResponse) Descriptor() ([]byte, []int) {
	return file_yandex_cloud_mdb_redis_v1_resource_preset_service_proto_rawDescGZIP(), []int{2}
}
...
var file_yandex_cloud_mdb_redis_v1_resource_preset_service_proto_rawDesc = []byte{
	0x0a, 0x37, 0x79, 0x61, 0x6e, 0x64, 0x65, 0x78, 0x2f, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2f, 0x6d,
	0x64, 0x62, 0x2f, 0x72, 0x65, 0x64, 0x69, 0x73, 0x2f, 0x76, 0x31, 0x2f, 0x72, 0x65, 0x73, 0x6f,
	...
	0x2f, 0x6d, 0x64, 0x62, 0x2f, 0x72, 0x65, 0x64, 0x69, 0x73, 0x2f, 0x76, 0x31, 0x2f, 0x72, 0x65,
	...
	0x49, 0x64, 0x22, 0x58, 0x0a, 0x1a, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72,
	...
	0x09, 0x52, 0x09, 0x70, 0x61, 0x67, 0x65, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x9b, 0x01, 0x0a,
	0x1b, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x50, 0x72, 0x65,
	0x73, 0x65, 0x74, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x54, 0x0a, 0x10,
	0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f, 0x70, 0x72, 0x65, 0x73, 0x65, 0x74, 0x73,
	...
	,
	...
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x50, 0x72, 0x65, 0x73, 0x65, 0x74, 0x22, 0x3e, 0x82, 0xd3,
	0xe4, 0x93, 0x02, 0x38, 0x12, 0x36, 0x2f, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x64, 0x2d, 0x72,
	0x65, 0x64, 0x69, 0x73, 0x2f, 0x76, 0x31, 0x2f, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65,
	0x50, 0x72, 0x65, 0x73, 0x65, 0x74, 0x73, 0x2f, 0x7b, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63,
	0x65, 0x5f, 0x70, 0x72, 0x65, 0x73, 0x65, 0x74, 0x5f, 0x69, 0x64, 0x7d, 0x12, 0xa0, 0x01, 0x0a,
	0x04, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x35, 0x2e, 0x79, 0x61, 0x6e, 0x64, 0x65, 0x78, 0x2e, 0x63,
	...
	0x65, 0x73, 0x65, 0x74, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x36, 0x2e, 0x79,
	0x61, 0x6e, 0x64, 0x65, 0x78, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x6d, 0x64, 0x62, 0x2e,
	0x72, 0x65, 0x64, 0x69, 0x73, 0x2e, 0x76, 0x31, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x73,
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x50, 0x72, 0x65, 0x73, 0x65, 0x74, 0x73, 0x52, 0x65, 0x73, 0x70,
	...
	0x61, 0x70, 0x69, 0x2e, 0x6d, 0x64, 0x62, 0x2e, 0x72, 0x65, 0x64, 0x69, 0x73, 0x2e, 0x76, 0x31,
	...
	0x75, 0x64, 0x2f, 0x6d, 0x64, 0x62, 0x2f, 0x72, 0x65, 0x64, 0x69, 0x73, 0x2f, 0x76, 0x31, 0x3b,
	0x72, 0x65, 0x64, 0x69, 0x73, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_yandex_cloud_mdb_redis_v1_resource_preset_service_proto_rawDescOnce sync.Once
	file_yandex_cloud_mdb_redis_v1_resource_preset_service_proto_rawDescData = file_yandex_cloud_mdb_redis_v1_resource_preset_service_proto_rawDesc
)

func file_yandex_cloud_mdb_redis_v1_resource_preset_service_proto_rawDescGZIP() []byte {
	file_yandex_cloud_mdb_redis_v1_resource_preset_service_proto_rawDescOnce.Do(func() {
		file_yandex_cloud_mdb_redis_v1_resource_preset_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_yandex_cloud_mdb_redis_v1_resource_preset_service_proto_rawDescData)
	})
	return file_yandex_cloud_mdb_redis_v1_resource_preset_service_proto_rawDescData
}

var file_yandex_cloud_mdb_redis_v1_resource_preset_service_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_yandex_cloud_mdb_redis_v1_resource_preset_service_proto_goTypes = []interface{}{
	(*GetResourcePresetRequest)(nil),    // 0: yandex.cloud.mdb.redis.v1.GetResourcePresetRequest
	(*ListResourcePresetsRequest)(nil),  // 1: yandex.cloud.mdb.redis.v1.ListResourcePresetsRequest
	(*ListResourcePresetsResponse)(nil), // 2: yandex.cloud.mdb.redis.v1.ListResourcePresetsResponse
	(*ResourcePreset)(nil),              // 3: yandex.cloud.mdb.redis.v1.ResourcePreset
}
var file_yandex_cloud_mdb_redis_v1_resource_preset_service_proto_depIdxs = []int32{
	3, // 0: yandex.cloud.mdb.redis.v1.ListResourcePresetsResponse.resource_presets:type_name -> yandex.cloud.mdb.redis.v1.ResourcePreset
	0, // 1: yandex.cloud.mdb.redis.v1.ResourcePresetService.Get:input_type -> yandex.cloud.mdb.redis.v1.GetResourcePresetRequest
	1, // 2: yandex.cloud.mdb.redis.v1.ResourcePresetService.List:input_type -> yandex.cloud.mdb.redis.v1.ListResourcePresetsRequest
	3, // 3: yandex.cloud.mdb.redis.v1.ResourcePresetService.Get:output_type -> yandex.cloud.mdb.redis.v1.ResourcePreset
	2, // 4: yandex.cloud.mdb.redis.v1.ResourcePresetService.List:output_type -> yandex.cloud.mdb.redis.v1.ListResourcePresetsResponse
...
func init() { file_yandex_cloud_mdb_redis_v1_resource_preset_service_proto_init() }
func file_yandex_cloud_mdb_redis_v1_resource_preset_service_proto_init() {
	if File_yandex_cloud_mdb_redis_v1_resource_preset_service_proto != nil {
		return
	}
	file_yandex_cloud_mdb_redis_v1_resource_preset_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_yandex_cloud_mdb_redis_v1_resource_preset_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_yandex_cloud_mdb_redis_v1_resource_preset_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_yandex_cloud_mdb_redis_v1_resource_preset_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_yandex_cloud_mdb_redis_v1_resource_preset_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_yandex_cloud_mdb_redis_v1_resource_preset_service_proto_goTypes,
		DependencyIndexes: file_yandex_cloud_mdb_redis_v1_resource_preset_service_proto_depIdxs,
		MessageInfos:      file_yandex_cloud_mdb_redis_v1_resource_preset_service_proto_msgTypes,
	}.Build()
	File_yandex_cloud_mdb_redis_v1_resource_preset_service_proto = out.File
	file_yandex_cloud_mdb_redis_v1_resource_preset_service_proto_rawDesc = nil
	file_yandex_cloud_mdb_redis_v1_resource_preset_service_proto_goTypes = nil
	file_yandex_cloud_mdb_redis_v1_resource_preset_service_proto_depIdxs = nil
}
