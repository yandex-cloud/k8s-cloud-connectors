...
func (x *ConnectionLimits) GetMaxQuestionsPerHour() *wrappers.Int64Value {
	if x != nil {
...
func (x *ConnectionLimits) GetMaxUpdatesPerHour() *wrappers.Int64Value {
	if x != nil {
...
func (x *ConnectionLimits) GetMaxConnectionsPerHour() *wrappers.Int64Value {
	if x != nil {
...
func (x *ConnectionLimits) GetMaxUserConnections() *wrappers.Int64Value {
	if x != nil {
