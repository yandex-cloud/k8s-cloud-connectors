...
type ClickhouseConfig struct {
	...
	BackgroundSchedulePoolSize *wrappers.Int64Value      `protobuf:"bytes,34,opt,name=background_schedule_pool_size,json=backgroundSchedulePoolSize,proto3" json:"background_schedule_pool_size,omitempty"`
}
...
type ClickhouseConfig_MergeTree struct {
	...
	MaxBytesToMergeAtMaxSpaceInPool *wrappers.Int64Value `protobuf:"bytes,8,opt,name=max_bytes_to_merge_at_max_space_in_pool,json=maxBytesToMergeAtMaxSpaceInPool,proto3" json:"max_bytes_to_merge_at_max_space_in_pool,omitempty"`
}
