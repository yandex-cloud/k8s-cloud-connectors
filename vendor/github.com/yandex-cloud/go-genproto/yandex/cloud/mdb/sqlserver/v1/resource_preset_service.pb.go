...
func (x *GetResourcePresetRequest) Reset() {
	*x = GetResourcePresetRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_yandex_cloud_mdb_sqlserver_v1_resource_preset_service_proto_msgTypes[0]
...
func (*GetResourcePresetRequest) Descriptor() ([]byte, []int) {
	return file_yandex_cloud_mdb_sqlserver_v1_resource_preset_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *ListResourcePresetsRequest) Reset() {
	*x = ListResourcePresetsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_yandex_cloud_mdb_sqlserver_v1_resource_preset_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ListResourcePresetsRequest) Descriptor() ([]byte, []int) {
	return file_yandex_cloud_mdb_sqlserver_v1_resource_preset_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *ListResourcePresetsResponse) Reset() {
	*x = ListResourcePresetsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_yandex_cloud_mdb_sqlserver_v1_resource_preset_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ListResourcePresetsResponse) Descriptor() ([]byte, []int) {
	return file_yandex_cloud_mdb_sqlserver_v1_resource_preset_service_proto_rawDescGZIP(), []int{2}
}
...
var file_yandex_cloud_mdb_sqlserver_v1_resource_preset_service_proto_rawDesc = []byte{
	...
	,
	...
	0xaa, 0x01, 0x0a, 0x1b, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65,
	0x50, 0x72, 0x65, 0x73, 0x65, 0x74, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12,
	0x58, 0x0a, 0x10, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f, 0x70, 0x72, 0x65, 0x73,
	0x65, 0x74, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2d, 0x2e, 0x79, 0x61, 0x6e, 0x64,
	...
	0x65, 0x78, 0x74, 0x50, 0x61, 0x67, 0x65, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x32, 0xf2, 0x02, 0x0a,
	0x15, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x50, 0x72, 0x65, 0x73, 0x65, 0x74, 0x53,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0xad, 0x01, 0x0a, 0x03, 0x47, 0x65, 0x74, 0x12, 0x37,
	0x2e, 0x79, 0x61, 0x6e, 0x64, 0x65, 0x78, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x6d, 0x64,
	0x62, 0x2e, 0x73, 0x71, 0x6c, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x47,
	0x65, 0x74, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x50, 0x72, 0x65, 0x73, 0x65, 0x74,
	...
	0x50, 0x72, 0x65, 0x73, 0x65, 0x74, 0x22, 0x3e, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x38, 0x12, 0x36,
	...
	0x65, 0x74, 0x5f, 0x69, 0x64, 0x7d, 0x12, 0xa8, 0x01, 0x0a, 0x04, 0x4c, 0x69, 0x73, 0x74, 0x12,
	...
	0x65, 0x74, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x3a, 0x2e, 0x79, 0x61, 0x6e,
	0x64, 0x65, 0x78, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x6d, 0x64, 0x62, 0x2e, 0x73, 0x71,
	0x6c, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x52,
	...
	0x2f, 0x6d, 0x64, 0x62, 0x2f, 0x73, 0x71, 0x6c, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2f, 0x76,
	0x31, 0x2f, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x50, 0x72, 0x65, 0x73, 0x65, 0x74,
	0x73, 0x42, 0x76, 0x0a, 0x21, 0x79, 0x61, 0x6e, 0x64, 0x65, 0x78, 0x2e, 0x63, 0x6c, 0x6f, 0x75,
	0x64, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x6d, 0x64, 0x62, 0x2e, 0x73, 0x71, 0x6c, 0x73, 0x65, 0x72,
	0x76, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x42, 0x04, 0x50, 0x53, 0x52, 0x53, 0x5a, 0x4b, 0x67, 0x69,
	...
	0x64, 0x62, 0x2f, 0x73, 0x71, 0x6c, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2f, 0x76, 0x31, 0x3b,
	0x73, 0x71, 0x6c, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}

var (
	file_yandex_cloud_mdb_sqlserver_v1_resource_preset_service_proto_rawDescOnce sync.Once
	file_yandex_cloud_mdb_sqlserver_v1_resource_preset_service_proto_rawDescData = file_yandex_cloud_mdb_sqlserver_v1_resource_preset_service_proto_rawDesc
)

func file_yandex_cloud_mdb_sqlserver_v1_resource_preset_service_proto_rawDescGZIP() []byte {
	file_yandex_cloud_mdb_sqlserver_v1_resource_preset_service_proto_rawDescOnce.Do(func() {
		file_yandex_cloud_mdb_sqlserver_v1_resource_preset_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_yandex_cloud_mdb_sqlserver_v1_resource_preset_service_proto_rawDescData)
	})
	return file_yandex_cloud_mdb_sqlserver_v1_resource_preset_service_proto_rawDescData
}

var file_yandex_cloud_mdb_sqlserver_v1_resource_preset_service_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_yandex_cloud_mdb_sqlserver_v1_resource_preset_service_proto_goTypes = []interface{}{
	(*GetResourcePresetRequest)(nil),    // 0: yandex.cloud.mdb.sqlserver.v1.GetResourcePresetRequest
	(*ListResourcePresetsRequest)(nil),  // 1: yandex.cloud.mdb.sqlserver.v1.ListResourcePresetsRequest
	(*ListResourcePresetsResponse)(nil), // 2: yandex.cloud.mdb.sqlserver.v1.ListResourcePresetsResponse
	(*ResourcePreset)(nil),              // 3: yandex.cloud.mdb.sqlserver.v1.ResourcePreset
}
var file_yandex_cloud_mdb_sqlserver_v1_resource_preset_service_proto_depIdxs = []int32{
	3, // 0: yandex.cloud.mdb.sqlserver.v1.ListResourcePresetsResponse.resource_presets:type_name -> yandex.cloud.mdb.sqlserver.v1.ResourcePreset
	0, // 1: yandex.cloud.mdb.sqlserver.v1.ResourcePresetService.Get:input_type -> yandex.cloud.mdb.sqlserver.v1.GetResourcePresetRequest
	1, // 2: yandex.cloud.mdb.sqlserver.v1.ResourcePresetService.List:input_type -> yandex.cloud.mdb.sqlserver.v1.ListResourcePresetsRequest
	3, // 3: yandex.cloud.mdb.sqlserver.v1.ResourcePresetService.Get:output_type -> yandex.cloud.mdb.sqlserver.v1.ResourcePreset
	2, // 4: yandex.cloud.mdb.sqlserver.v1.ResourcePresetService.List:output_type -> yandex.cloud.mdb.sqlserver.v1.ListResourcePresetsResponse
...
func init() { file_yandex_cloud_mdb_sqlserver_v1_resource_preset_service_proto_init() }
func file_yandex_cloud_mdb_sqlserver_v1_resource_preset_service_proto_init() {
	if File_yandex_cloud_mdb_sqlserver_v1_resource_preset_service_proto != nil {
		return
	}
	file_yandex_cloud_mdb_sqlserver_v1_resource_preset_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_yandex_cloud_mdb_sqlserver_v1_resource_preset_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_yandex_cloud_mdb_sqlserver_v1_resource_preset_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_yandex_cloud_mdb_sqlserver_v1_resource_preset_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_yandex_cloud_mdb_sqlserver_v1_resource_preset_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_yandex_cloud_mdb_sqlserver_v1_resource_preset_service_proto_goTypes,
		DependencyIndexes: file_yandex_cloud_mdb_sqlserver_v1_resource_preset_service_proto_depIdxs,
		MessageInfos:      file_yandex_cloud_mdb_sqlserver_v1_resource_preset_service_proto_msgTypes,
	}.Build()
	File_yandex_cloud_mdb_sqlserver_v1_resource_preset_service_proto = out.File
	file_yandex_cloud_mdb_sqlserver_v1_resource_preset_service_proto_rawDesc = nil
	file_yandex_cloud_mdb_sqlserver_v1_resource_preset_service_proto_goTypes = nil
	file_yandex_cloud_mdb_sqlserver_v1_resource_preset_service_proto_depIdxs = nil
}
...
func (c *resourcePresetServiceClient) Get(ctx context.Context, in *GetResourcePresetRequest, opts ...grpc.CallOption) (*ResourcePreset, error) {
	...
	err := c.cc.Invoke(ctx, "/yandex.cloud.mdb.sqlserver.v1.ResourcePresetService/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *resourcePresetServiceClient) List(ctx context.Context, in *ListResourcePresetsRequest, opts ...grpc.CallOption) (*ListResourcePresetsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/yandex.cloud.mdb.sqlserver.v1.ResourcePresetService/List", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ResourcePresetService_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/yandex.cloud.mdb.sqlserver.v1.ResourcePresetService/Get",
	}
...
func _ResourcePresetService_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/yandex.cloud.mdb.sqlserver.v1.ResourcePresetService/List",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _ResourcePresetService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "yandex.cloud.mdb.sqlserver.v1.ResourcePresetService",
	...
	Metadata: "yandex/cloud/mdb/sqlserver/v1/resource_preset_service.proto",
}
