...
func (x *CreateSymmetricKeyRequest) GetRotationPeriod() *duration.Duration {
	if x != nil {
...
type UpdateSymmetricKeyRequest struct {
	...
	RotationPeriod *duration.Duration `protobuf:"bytes,8,opt,name=rotation_period,json=rotationPeriod,proto3" json:"rotation_period,omitempty"` // period between two automatic rotations
	// Flag that inhibits deletion of the symmetric KMS key
...
func (x *UpdateSymmetricKeyRequest) GetUpdateMask() *field_mask.FieldMask {
	if x != nil {
		return x.UpdateMask
	}
	return nil
...
func (x *UpdateSymmetricKeyRequest) GetRotationPeriod() *duration.Duration {
	if x != nil {
		return x.RotationPeriod
	}
	return nil
...
func (x *ScheduleSymmetricKeyVersionDestructionRequest) GetPendingPeriod() *duration.Duration {
	if x != nil {
...
func (x *ScheduleSymmetricKeyVersionDestructionMetadata) GetDestroyAt() *timestamp.Timestamp {
	if x != nil {
		return x.DestroyAt
	}
	return nil
