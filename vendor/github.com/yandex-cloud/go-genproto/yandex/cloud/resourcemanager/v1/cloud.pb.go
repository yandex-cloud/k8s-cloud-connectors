...
func (x *Cloud) GetCreatedAt() *timestamp.Timestamp {
	if x != nil {
		return x.CreatedAt
	}
	return nil
...
var file_yandex_cloud_resourcemanager_v1_cloud_proto_rawDesc = []byte{
	...
	0x88, 0x01, 0x0a, 0x05, 0x43, 0x6c, 0x6f, 0x75, 0x64, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18,
	...
	0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0x7a, 0x0a, 0x23, 0x79, 0x61,
...
var file_yandex_cloud_resourcemanager_v1_cloud_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
...
var file_yandex_cloud_resourcemanager_v1_cloud_proto_depIdxs = []int32{
	1, // 0: yandex.cloud.resourcemanager.v1.Cloud.created_at:type_name -> google.protobuf.Timestamp
