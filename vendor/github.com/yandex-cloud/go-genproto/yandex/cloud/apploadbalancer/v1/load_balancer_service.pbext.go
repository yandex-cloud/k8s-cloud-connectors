...
func (m *UpdateLoadBalancerRequest) SetUpdateMask(v *field_mask.FieldMask) {
	m.UpdateMask = v
}
...
func (m *UpdateListenerRequest) SetUpdateMask(v *field_mask.FieldMask) {
	m.UpdateMask = v
}
...
func (m *UpdateSniMatchRequest) SetUpdateMask(v *field_mask.FieldMask) {
	m.UpdateMask = v
}
