...
func TestRead(t *testing.T) {
	t.Run(
		"read on one object", func(t *testing.T) {
			// Arrange
	...
	t.Run(
		"read on multiple objects", func(t *testing.T) {
			// Arrange
			ctx := context.Background()
			ad := NewFakeYandexContainerRegistryAdapter()
			reg1 := containerregistry.CreateRegistryRequest{
	...
	t.Run(
		"read on no object", func(t *testing.T) {
			// Arrange
			ctx := context.Background()
			ad := NewFakeYandexContainerRegistryAdapter()
...
func TestList(t *testing.T) {
	t.Run(
		"list on one object", func(t *testing.T) {
			// Arrange
			ctx := context.Background()
			ad := NewFakeYandexContainerRegistryAdapter()
			reg1 := containerregistry.CreateRegistryRequest{
	...
	t.Run(
		"list on multiple objects", func(t *testing.T) {
			// Arrange
			ctx := context.Background()
			ad := NewFakeYandexContainerRegistryAdapter()
			reg1 := containerregistry.CreateRegistryRequest{
	...
	t.Run(
		"list on no object", func(t *testing.T) {
			// Arrange
			ctx := context.Background()
			ad := NewFakeYandexContainerRegistryAdapter()
...
func TestUpdate(t *testing.T) {
	t.Run(
		"update on one object on name field", func(t *testing.T) {
			// Arrange
			ctx := context.Background()
			ad := NewFakeYandexContainerRegistryAdapter()
			reg1 := containerregistry.CreateRegistryRequest{
	...
	t.Run(
		"update on one object on labels field", func(t *testing.T) {
			// Arrange
			ctx := context.Background()
			ad := NewFakeYandexContainerRegistryAdapter()
			reg1 := containerregistry.CreateRegistryRequest{
	...
	t.Run(
		"update on one object on name and labels fields", func(t *testing.T) {
			// Arrange
			ctx := context.Background()
			ad := NewFakeYandexContainerRegistryAdapter()
			reg1 := containerregistry.CreateRegistryRequest{
	...
	t.Run(
		"update on one object on no fields", func(t *testing.T) {
			// Arrange
			ctx := context.Background()
			ad := NewFakeYandexContainerRegistryAdapter()
			reg1 := containerregistry.CreateRegistryRequest{
	...
	t.Run(
		"update on no object", func(t *testing.T) {
			// Arrange
			ctx := context.Background()
			ad := NewFakeYandexContainerRegistryAdapter()
			reg1 := containerregistry.CreateRegistryRequest{
...
func TestDelete(t *testing.T) {
	t.Run(
		"delete on one object", func(t *testing.T) {
			// Arrange
			ctx := context.Background()
			ad := NewFakeYandexContainerRegistryAdapter()
			reg1 := containerregistry.CreateRegistryRequest{
	...
	t.Run(
		"delete on multiple objects", func(t *testing.T) {
			// Arrange
			ctx := context.Background()
			ad := NewFakeYandexContainerRegistryAdapter()
			reg1 := containerregistry.CreateRegistryRequest{
	...
	t.Run(
		"delete on no object", func(t *testing.T) {
			// Arrange
			ctx := context.Background()
			ad := NewFakeYandexContainerRegistryAdapter()
			reg1 := containerregistry.CreateRegistryRequest{
